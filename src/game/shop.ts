...
// Import CSS from separate file for better maintainability
...
// CSS is now imported via the import statement at the top of the file.
// The shop.css module handles injection automatically.
